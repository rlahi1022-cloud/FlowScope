...
// ------------------------------------------------
eventbus4& eventbus4::instance()
{
    static eventbus4 bus;
    return bus;
}
...
// ------------------------------------------------
void eventbus4::subscribe(const std::string& topic, handler_fn fn)
{
...
// ------------------------------------------------
void eventbus4::publish(const std::string& topic, const std::string& data)
{
